export default {
  ru: {
    ...
    "result.partialHint": "Не удалось автоматически перевести отдельные строки — их можно поправить в редакторе. Остальной модуль уже переведён, его можно скачать.",
    "result.file": "Файл:",
    ...
    "result.editFailed": "Непереведённые",
    ...
    "editor.files": "Файлы",
    "editor.search": "Поиск...",
    "editor.failedOnly": "Только непереведённые",
    "editor.noFailed": "Нет строк, которые не удалось перевести",
    "editor.syncShared": "Править одинаковый текст везде сразу",
    "editor.original": "Оригинал",
    "editor.speaker": "Говорит",
    "editor.speakerPlayer": "Игрок",
    "editor.speakerOwner": "Владелец диалога",
    "editor.occurrences": "Столько раз этот текст встречается в файле; правка изменит все",
  ...
  en: {
    ...
    "result.partialHint": "A few lines could not be translated automatically — you can fix them in the editor. The rest of the module is translated and ready to download.",
    "result.file": "File:",
    ...
    "result.editFailed": "Untranslated",
    ...
    "editor.failedOnly": "Untranslated only",
    "editor.noFailed": "No lines the AI failed to translate",
    "editor.syncShared": "Edit identical text everywhere at once",
    "editor.original": "Original",
    "editor.speaker": "Speaker",
    "editor.speakerPlayer": "Player",
    "editor.speakerOwner": "Dialog owner",
    "editor.occurrences": "This text occurs this many times in the file; an edit changes all of them",
