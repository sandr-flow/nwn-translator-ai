...
This provider supports GPT-4 and GPT-3.5 models for translation.
"""
    ...
    def translate(
        ...
        try:
            ...
            if "rate_limit" in error_msg.lower() or "429" in error_msg:
                raise RateLimitError(f"OpenAI rate limit exceeded: {error_msg}") from e
            raise OpenAIError(f"OpenAI translation failed: {error_msg}") from e
